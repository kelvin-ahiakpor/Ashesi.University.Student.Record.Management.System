...
//Helper Methods for Faculty Management
//Ensures Clean Code
...
System::Void AshesiUniversityStudentRecordManagementSystem::FacultyManagementForm::DeleteFaculty(DatabaseManager^ db, Object^ sender, EventArgs^ e)
{
    db->ConnectToDatabase();
...
System::Void AshesiUniversityStudentRecordManagementSystem::FacultyManagementForm::CreateFaculty(DatabaseManager^ db, Object^ sender, EventArgs^ e)
{
